...
实际开发中难免会遇到这种特殊场景，我们可以通过**ghttp.BindControllerMethod**方法完成对控制器方法的注册。相对于ghttp.BindController注册方法，多了一个方法名称参数methods，参数支持传入多个方法名称，多个名称以英文“,”号分隔。

以下是一个示例(gitee.com/johng/gf/geg/frame/mvc/controller/demo/method.go)：
```go
package demo
