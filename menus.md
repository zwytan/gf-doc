...
* [WEB服务开发](#)
    ...
    * [服务注册](#)
        ...
        * [函数注册](net/ghttp/service/handler.md)
        * [对象注册](net/ghttp/service/object.md)
        * [控制器注册](net/ghttp/service/controller.md)
        * [事件回调](net/ghttp/service/hook.md)
...
* [功能模块设计](#)
    ...
    * [数据管理模块](#)
        * [gdb (数据库ORM)](database/gdb/index.md)
    ...
    * [编码解码模块](#)
        ...
        * [gbase64 (BASE64编码解析)](encoding/gbase64/index.md)
        * [ghash (经典哈希函数)](encoding/ghash/index.md)
        * [ghtml (HTML编码解析)](encoding/ghtml/index.md)
        * [gurl (URL编码解析)](encoding/gurl/index.md)
        * [gxml (XML编码解析)](encoding/gxml/index.md)
        * [gyaml (YAML编码解析)](encoding/gyaml/index.md)
        * [gtoml (TOML编码解析)](encoding/gtoml/index.md)
        * [gcompress (数据压缩/解压)](encoding/gcompress/index.md)
    * [加密解密模块](#)
    ...
    * [实用工具模块](#)
        * [gconv (类型转换模块)](util/gconv/index.md)
            * [基本介绍](util/gconv/index.md)
            * [基本类型](util/gconv/basic.md)
            * [Map类型转换](util/gconv/map.md)
