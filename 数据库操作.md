...
gdb提供简便灵活的链式操作接口，通过gdb.Table方法基于数据表返回一个链式操作对象gLinkOp，该对象定义为非公开对象，可以执行以下方法。
...
// 链式操作，consition
func Condition(condition string, args...interface{}) (*gLinkOp)
// 链式操作，group by
...
func BatchReplace() error
// 链式操作， CURD - BatchSave
func BatchSave() error
// 链式操作， CURD - Update
