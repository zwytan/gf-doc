...
由于gdb包功能强大，使用文档分为两个章节进行介绍，基本使用章节以及高级用法章节。基本使用章节主要对gdb做基本的使用介绍；高级用法章节主要对gdb包做了更多详细的介绍，以及一些与gf框架集成的关联包介绍。

本章节属于基本使用章节，包含：gdb包基本的介绍，配置管理功能说明，常见用法及常用操作示例。
...
gdb数据库操作的方法比较多，具体请查看[godoc](https://godoc.org/github.com/johng-cn/gf/g/database/gdb)，以下仅对一些常用的方法进行介绍。
